...
namespace dockadmin
{
    public class Utility
    {
        ...
        public List<Boat> GenerateRandomBoat(int amountOfBoatsToGenerate)
        {
            ...
            {
                int TypeOfBoatToGenerate = _rnd.Next(1, 5);
                if (TypeOfBoatToGenerate == 1)
                {
                ...
                if(TypeOfBoatToGenerate == 4)
                {
                    randomBoats.Add(CreateRowBoat());
                }
            }
            return randomBoats;
        }
        ...
        public RowBoat CreateRowBoat()
        {
            RowBoat boat = new RowBoat(
                boatId: $"R-{RandomSuffix()}",
                weight: _rnd.Next(100, 301),
                maxSpeed: _rnd.Next(0, 4),
                passengers: _rnd.Next(1, 7),
                boatSize: 1,
                daysToStay: 1
                );
            return boat;
